...
const experiences = [
  {
    ...
    description: "Built QR code scanner for event check-in and streamlined event management.",
  },
  {
...
export default function Experience() {
  return (
    <section id="experience" className="min-h-screen px-4 py-10 text-center">
      <motion.h2
      ...
      <div className="max-w-4xl mx-auto space-y-6 text-left">
        {experiences.map((exp, idx) => (
          ...
          >
            ...
            <p className="text-gray-300 text-sm">{exp.role} | {exp.duration}</p>
