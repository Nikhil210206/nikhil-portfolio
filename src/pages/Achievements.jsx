			...
			<div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-4xl mx-auto">
				{achievements.map((item, idx) => (
					<motion.div
						...
						className="bg-white/5 border border-white/10 shadow-xl backdrop-blur-2xl p-6 rounded-xl transition-transform duration-300 hover:scale-[1.02] hover:ring-1 hover:ring-white/20 text-white"
					>
						{item}
					</motion.div>
				))}
